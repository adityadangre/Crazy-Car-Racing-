...
var one,one_img,hp,hp_img,nofuel_img,nofuel;
...
function preload(){
    ...
    help_img = loadImage("images/obstacles/help.png");//Image Sprite for Help
    one_img = loadImage("images/onepoint.png");//+1 Point Image
    hp_img = loadImage("images/100p.png");//+100 point image
    nofuel_img = loadImage("images/obstacles/nofuel.png"); // No fuel image
    ...
    fueltank_img = loadImage("images/obstacles/petrol.png"); //Fule Tank Image
    coin_img = loadAnimation("images/coin/coin.png","images/coin/coin1.png","images/coin/coin2.png","images/coin/coin3.png","images/coin/coin4.png","images/coin/coin5.png","images/coin/coin6.png");//Coin image animation

    startpoint_img = loadImage("images/obstacles/start.png"); //Start Point Image
    //animation for Bomb Spot
...
function draw(){
    ...
    drawSprites();
    //display of Distance, Fuel, Life, COin count
    if(gameState===3){
        textSize(25);
        fill("white");
        stroke("black");
